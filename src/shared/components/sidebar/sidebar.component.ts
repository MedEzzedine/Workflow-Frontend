...
export const ROUTES: RouteInfo[] = [
   ...
   // { path: '/icons', title: 'Icons',  icon:'education_atom', class: '' },
    ...
    { path: '/admin/demande/alldemande', title: 'Mes demandes',  icon:'users_single-02', class: '' ,permissions:["add_conge","tritux"]},
    { path: '/admin/users/adduser', title: 'add_users',  icon:'users_single-02', class: '',permissions:["add_user"] },
    { path: '/admin/users/alluser', title: 'List_users',  icon:'users_single-02', class: '',permissions:["tritux","list_user"] },
    { path: '/admin/demande/demanderecue', title: ' demandes en attentes',  icon:'users_single-02', class: '',permissions:["A/R_conge"] },
    { path: '/admin/demande/demandefinaldesicion', title: 'final_traitement',  icon:'users_single-02', class: '',permissions:["drh"] },
